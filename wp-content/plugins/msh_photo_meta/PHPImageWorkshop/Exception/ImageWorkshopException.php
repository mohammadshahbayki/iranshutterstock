...
//use ImageWorkshopBaseException as ImageWorkshopBaseException;

// If no autoloader, uncomment these lines:
require_once(MSHPM_PLUGINS_DIR_PATH.'PHPImageWorkshop/Exception/ImageWorkshopBaseException.php');
