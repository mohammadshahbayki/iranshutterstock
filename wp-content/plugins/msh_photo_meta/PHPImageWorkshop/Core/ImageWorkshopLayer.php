...
require_once(MSHPM_PLUGINS_DIR_PATH.'PHPImageWorkshop/Exif/ExifOrientations.php');
require_once(MSHPM_PLUGINS_DIR_PATH.'PHPImageWorkshop/ImageWorkshop.php');
require_once(MSHPM_PLUGINS_DIR_PATH.'PHPImageWorkshop/Core/ImageWorkshopLib.php');
require_once(MSHPM_PLUGINS_DIR_PATH.'PHPImageWorkshop/Core/Exception/ImageWorkshopLayerException.php');
